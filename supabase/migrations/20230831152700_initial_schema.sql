...
CREATE TABLE IF NOT EXISTS public.events (
    id TEXT PRIMARY KEY DEFAULT (gen_random_uudio()),
    title TEXT NOT NULL,
...
CREATE INDEX idx_orders_event_id ON public.orders("eventId");
...
CREATE INDEX idx_ticket_tiers_event_id ON public.ticket_tiers("eventId");

...
const sql = `-- Enable required extensions
...
// Create the SQL file
const outputPath = path.join(process.cwd(), 'supabase', 'migrations', 'schema.sql');
...
console.log('4. Copy the contents of the generated SQL file and paste it into the editor');
console.log('5. Click "Run" or press CMD+Enter (Mac) / Ctrl+Enter (Windows)');
